...
///
/// Required to be on an Inventory Slot with children gameObjects for Amount and Image
...
public class Inventory_Slot : MonoBehaviour
{
    ...
    public void PopulateSlot(Item_Stack stack)
    {
        ...
        // Hook Hover_Info if present
        Hover_Info hover = gameObject.GetComponent<Hover_Info>();
        if (hover != null)
            hover.SetItem(stack?.resource);
