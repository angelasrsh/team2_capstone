...
// Base stack as parent for IngredientStack and DishStack
public class Stack {
    public ResourceData resource; // Can fill with IngredientData or DishData
    public int amount;
}
...
public class Inventory : MonoBehaviour
{
    ...
    private void Awake()
    {
        InventoryStacks = new Stack[InventorySizeLimit];
    }
