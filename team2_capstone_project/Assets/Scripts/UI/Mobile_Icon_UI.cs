...
public class Mobile_Icon_UI : MonoBehaviour
{
  ...
  private Canvas_Inventory_Listener inventoryListener;
  private Canvas_Inventory_Listener dishInventoryListener;
  ...
  {
    if (inventoryCanvas != null && dishInventoryListener != null && inventoryCanvas.enabled)
    {
      // inventoryCanvas.enabled = false;
      inventoryListener.MobileClosePressed();
      dishInventoryListener.MobileClosePressed();
  ...
  public void OnInventoryButtonPressed()
  {
    ...
    dishInventoryListener = GameObject.Find("Canvas_Dish_Tool_Inventory")?.GetComponent<Canvas_Inventory_Listener>();
    inventoryListener = inventoryCanvas.gameObject.GetComponent<Canvas_Inventory_Listener>();
    ...
    {
      DisableMainButtons();
      inventoryListener.MobileOpenPressed();
      dishInventoryListener.MobileOpenPressed();
